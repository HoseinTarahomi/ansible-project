...
* Target Node (ubuntu2): سرور اصلی پروداکشن میزبان کانتینرها روی شبکه ایزوله proxy.
...
### ۱. پیش‌نیازها
* کنترل‌نود مجهز به Ansible 2.15+
* دسترسی SSH با کلید (SSH Key) به سرورهای مقصد
* فایل رازها رمزنگاری‌شده با Ansible Vault
